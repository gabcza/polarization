...
#---- Save full data ----
write.csv2(data, "polarization study US US full data.csv", row.names = FALSE)
#write.csv(data, "polarization study US US full data.csv", row.names = FALSE)
...
nrow(data) # N = 1642
# TO DO: tu trzeba będzie jeszcze usunąć ew. spacje etc.
# att4
